...
function draw() {
  ...
  metronome(100, 175, 1.5, sin((frameCount5 / 60) * PI * 2) * 0.5);
  metronome(300, 175, 1.5, sin((frameCount15 / 60) * PI * 2) * 0.5);
  metronome(500, 175, 1.5, sin((frameCount30 / 60) * PI * 2) * 0.5);
  metronome(700, 175, 1.5, sin((frameCount60 / 60) * PI * 2) * 0.5);
}
