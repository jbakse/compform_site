...
const storyGrammar = {
  ...
  description: [
    "#face_sentence# #hair_sentence# #extra_sentence#",
    "#hair_sentence# #extra_sentence# #face_sentence#",
  ],
  ...
  extra_sentence: [
    "A #extra# draws your attention.",
    "A #extra# draws your eye.",
    "They have a #extra#.",
  ],
  ...
  face_adj_phrase: [
    "#modified_face_adj_quality# #face_adj_age#",
