...
const storyGrammar = {
  top: ["#div#"],
  div: [
    '<div style="border: #borderSize# #borderType# #borderColor#;  color: #borderColor#; text-align: center; text-transform: uppercase; font-family: sans-serif; margin: 10px;">#content#</div>',
  ],
